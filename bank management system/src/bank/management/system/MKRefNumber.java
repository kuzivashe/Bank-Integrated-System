...
public class MKRefNumber extends JFrame implements ActionListener {
    ...
    MKRefNumber(String pinnumber) {
        this.pinnumber = pinnumber;
        setTitle("Mukuru Reference Number Page");
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent ae) {
        try{        
            if(ae.getSource() == enter){
                ...
                String q  = "select * from mkrefnumber where refno = '"+refno+"'";

...
public class MKWithdrawl extends JFrame implements ActionListener {
    JLabel label1, label2, label3;
    String pinnumber;
    JButton withdraw, back;
    JTextField number;
    
    MKWithdrawl(String pinnumber) {
        this.pinnumber = pinnumber;
        setTitle("Remittance Withdrawls From Mukuru");
        setLayout(null);
        ...
        JLabel text = new JLabel("ENTER AMOUNT TO WITHDRAW FROM MUKURU");
        text.setBounds(160, 60, 350, 25);
        ...
        try{        
            ...
            if(ae.getSource() == withdraw){
                if(number.getText().equals("")){
                    ...
                    Conn c1 = new Conn();
                    c1.s.executeUpdate("insert into mkwithdrawls values('"+pinnumber+"', '"+date+"', 'MKWithdrawl', '"+amount+"')");
                    JOptionPane.showMessageDialog(null, "USD. "+amount+" withdrawn Successfully");
                    setVisible(false);
                    new MKWithdrawl(pinnumber).setVisible(true);
                }

...
public class WRRefNumber extends JFrame implements ActionListener {
    ...
    WRRefNumber(String pinnumber) {
        this.pinnumber = pinnumber;
        setTitle("World Remit Reference Number Page");
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent ae) {
        try{        
            if(ae.getSource() == enter){
                ...
                String q  = "select * from wrrefnumber where refno = '"+refno+"'";

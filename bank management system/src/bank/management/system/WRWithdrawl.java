...
public class WRWithdrawl extends JFrame implements ActionListener {
    JLabel label1, label2, label3;
    String pinnumber;
    JButton withdraw, back;
    JTextField number;
    
    WRWithdrawl(String pinnumber) {
        this.pinnumber = pinnumber;
        setTitle("Remittance Withdrawls From World Remit");
        setLayout(null);
        ...
        JLabel text = new JLabel("ENTER AMOUNT TO WITHDRAW FROM WORLD REMIT");
        ...
        try{        
            ...
            if(ae.getSource() == withdraw){
                if(number.getText().equals("")){
                    ...
                    Conn c1 = new Conn();
                    c1.s.executeUpdate("insert into wrwithdrawls values('"+pinnumber+"', '"+date+"', 'WRWithdrawl', '"+amount+"')");
                    JOptionPane.showMessageDialog(null, "USD. "+amount+" withdrawn Successfully");
                    setVisible(false);
                    new WRWithdrawl(pinnumber).setVisible(true);
                }
